...
/*
function birdIMG(birdName) {
    const matchingBird = json.find(bird => bird.Title === birdName);
    if (matchingBird) {
        image.src = matchingBird.Poster;
    } else {
        // Imagen por defecto si no se encuentra el pájaro
        image.src = "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/326175571/1200";
    }
    imageName.textContent = birdName;
}
*/
